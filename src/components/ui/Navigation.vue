<template>
  ...
  >
    ...
    >
      <div
        class="flex items-center text-gray-900 hover:text-gray-900 focus:text-gray-900 mr-1"
      >
        <!-- title -->
        <slot></slot>
      </div>
      <div
        class="flex items-center gap-1 text-gray-900 hover:text-accent hover:bg-gray-900 focus:text-accent focus:bg-gray-900 p-1 px-3 rounded cursor-pointer"
      >
